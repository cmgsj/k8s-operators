...
func main() {
	...
	flag.StringVar(&leaderElectionNamespace, "leader-election-namespace", "", "LeaderElectionNamespace determines the namespace in which the leader election resource will be created.")
